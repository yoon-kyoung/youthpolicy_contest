  ...
  if (!started) {
    return (
      ...
      >
        ...
        <div ref={orb2WrapRef} style={{position:'absolute',left:'47%',top:'24%',width:bp==='mobile'?'45vw':'19.5vw',aspectRatio:'1',pointerEvents:'none',zIndex:0,transition:'transform 0.4s ease-out'}}>
