...
export default function ChatBotView({ bp, favIds, onToggleFav, onGoDetail, resetSignal }) {
  ...
  if (!started) {
    return (
      ...
      >
        <div ref={orb1WrapRef} style={{position:'absolute',left:'29%',top:'34%',width:'25.5vw',aspectRatio:'1',pointerEvents:'none',zIndex:0,transition:'transform 0.4s ease-out'}}>
        ...
        <div ref={orb2WrapRef} style={{position:'absolute',left:'47%',top:'34%',width:'19.5vw',aspectRatio:'1',pointerEvents:'none',zIndex:0,transition:'transform 0.4s ease-out'}}>
